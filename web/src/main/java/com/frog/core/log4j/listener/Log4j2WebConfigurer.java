...
public abstract class Log4j2WebConfigurer {
			...
			try {
				...
				if (StringUtils.hasText(intervalString)) {
					...
					try {
						...
						Log4j2Configurer.initLogging(location, refreshInterval);
					}
					...
					Log4j2Configurer.initLogging(location);
				}
			}
	...
	public static void shutdownLogging(ServletContext servletContext) {
		...
		try {
			Log4j2Configurer.shutdownLogging();
		}
		finally {
